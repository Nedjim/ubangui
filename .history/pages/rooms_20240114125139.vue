...
const rooms_paragraph_1 =
  ...
  const rooms_paragraph_4 = "Elles sont équipées de climatiseurs, chauffe-eau, frigos-bar,  et ont des dispositifs  pour téléviseurs, wifi, etc. Les prix des chambres varient en fonction du nombre  d’occupants :";
</script>
